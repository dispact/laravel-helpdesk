<div>
    ...
    <div class="fixed z-50 inset-0 overflow-y-auto m-auto" aria-labelledby="modal-title" 
        role="dialog" aria-modal="true" x-show="isCreateStatusMenuOpen"
    >
        ...
        <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div class="inline-block align-bottom bg-white dark:bg-gray-700 rounded-lg text-left 
                ...
                @click.away="toggleCreateStatusMenu();removeErrorDecor()" 
                @close.stop="toggleCreateStatusMenu();removeErrorDecor()"
                x-on:keydown.escape="toggleCreateStatusMenu()"
            ...
            >
                <div class="bg-white dark:bg-gray-700 px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    <div class="sm:flex sm:items-start">
                        <div class="mx-auto flex-shrink-0 flex items-center 
                                justify-center h-12 w-12 rounded-full bg-red-100 dark:bg-red-200
                                sm:mx-0 sm:h-10 sm:w-10 text-red-500 dark:text-red-600"
                        >
                        ...
                        <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                            ...
                            <div class="space-y-4 mt-4 w-full">
                                <x-forms.input label="Name" id="name" placeholder="Name"/>
                                <x-forms.select-array label="Color" id="color" 
                ...
                <div class="bg-gray-50 dark:bg-gray-800 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                    ...
                    <button @click="toggleCreateStatusMenu();removeErrorDecor()" class="mt-3 w-full inline-flex justify-center rounded-md border 
...
function removeErrorDecor() {
    document.getElementById("name").classList.remove('border-red-500', 'dark:border-red-400');
    document.getElementById("color").classList.remove('border-red-500', 'dark:border-red-400');
}
</script>